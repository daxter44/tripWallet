...
export const setTripState = createAction(
  '[Trip Store] Set Trip',
  props<{ trip: trip }>()
);
...
export const addTripSuccess = createAction('[Trip Store] Add trip success');
...
export const loadTripStateSuccess = createAction(
  '[Trip Store] Load data into Trip success',
  props<{ entities: trip[] }>()
);
export const loadTripStateFailure = createAction(
  '[Trip Store] Load data into Trip failure',
  props<{ error: any }>()
);
...
export const saveTripStateFailure = createAction(
  '[Trip Store] Save trip data',
  props<{ error: any }>()
);
